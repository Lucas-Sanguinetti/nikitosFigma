    ...
    return (
        ...
        <div className="pt-20 overflow-y-auto h-screen">
                ...
                <div>
                    ...
                    <div>
                        <img src="images/aboutUs/aboutUs1.png" alt="About Us" />
                    </div>
                </div>

                <div>
                    <div>
                       <img src="images/aboutUs/aboutUs2.png" alt="About Us" />
                    </div>
                ...
                <div>
                    ...
                    <div>
                        <img src="images/aboutUs/aboutUs3.png" alt="About Us" />
                    </div>
                </div>

                <div>
                    <div>
                        <img src="images/aboutUs/aboutUs4.png" alt="About Us" />
                    </div>
                    <div>
                        <div>
                            Nuestra flota
